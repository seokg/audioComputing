...
int main(int argc, char** argv)
{
	...
	int i=1;
	//press 'esc' to stop
	while(waitKey(30) != 27)// continously capture the data
	{
		Mat image = imread("input.png", 1);
		...
		vector<vector<Point> > sqr;// corner of the marker
		find_squares(image, sqr);
...
/*
		...
		// ***** //
		// Marker Detection  //
		// TODO: detection method of the points //
		// ***** //
		int threshold = 50;
